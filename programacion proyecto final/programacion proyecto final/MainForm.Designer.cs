...
namespace programacion_proyecto_final
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.vercliente);
			...
			// vercliente
			// 
			this.vercliente.Image = ((System.Drawing.Image)(resources.GetObject("vercliente.Image")));
			this.vercliente.Location = new System.Drawing.Point(282, 195);
			this.vercliente.Name = "vercliente";
			this.vercliente.Size = new System.Drawing.Size(112, 23);
			this.vercliente.TabIndex = 9;
			this.vercliente.UseVisualStyleBackColor = true;
			this.vercliente.Click += new System.EventHandler(this.Button5Click);
			// 
			// button4
			// 
			this.button4.Image = ((System.Drawing.Image)(resources.GetObject("button4.Image")));
			this.button4.Location = new System.Drawing.Point(319, 67);
			...
			this.tablaCliente.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
									...
									this.Codigo,
									this.Cantidad});
			this.tablaCliente.Location = new System.Drawing.Point(27, 269);
			this.tablaCliente.Name = "tablaCliente";
			this.tablaCliente.Size = new System.Drawing.Size(394, 150);
			this.tablaCliente.TabIndex = 1;
			this.tablaCliente.CellContentClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.TablaClienteCellContentClick);
			// 
			// Producto
			// 
